...
export default function IndexSectionCallToAction9() {
  return (
    <React.Fragment>
      <>
            ...
            <div className="relative max-w-7xl mx-auto">
              <div className="flex flex-wrap -mx-4">
                <div className="w-full lg:w-2/3 xl:w-1/2 px-4 mb-16 lg:mb-0">
                  <div className="xs:max-w-xs sm:max-w-lg lg:max-w-xl">
                    ...
                    <p className="text-gray-500 mb-10">
                      ...
                      student-friendly interface, integrated educational VR
                      &amp; AR resources, and intuitive teacher controls. Our
                      easy-to-use teacher portal ensures a rich and reliable
                    ...
                    >
                      ...
                      <div className="relative flex items-center justify-center">
                        <span className="mr-4">Book a Demo</span>
                        <span>
                          <svg
                            width={8}
                            height={12}
                ...
                <div className="w-full lg:w-1/3 xl:w-1/2 px-4">
                  <img
                    className="w-full max-w-sm ml-auto shadow-2xl rounded-xl"
                    src="https://static.shuffle.dev/uploads/files/69/6978f95e8afa70d57782910ca264e7c3e432c077/Default-Create-an-image-of-a-classroom-setting-where-African-A-2.jpg"
                    alt
                  />
                </div>
              </div>
